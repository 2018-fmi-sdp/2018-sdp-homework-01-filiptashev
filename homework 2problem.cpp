...
a=1;
 ...
 cout<<"Filip Tashev Matematika 2017"<<endl;
    ...
    cout<<"It="<<It<<" Can skip? ";if(Kt01>=3.50&&Kt02>=3.50&&Kt01+Kt02>=9){cout<<"yes"<<(Kt01+Kt02)/2;}else{cout<<"no";};
     cout<<endl<<"Iz="<<Iz<<" Can skip? ";if(Kz01>=3.50&&Kz02>=3.50&&Kz01+Kz02>=9){cout<<"yes"<<(Kz01+Kz02)/2;}else{cout<<"no";};
    cout<<endl<<"I="<<((Iz+It)/2);cout<<" Skip T? " ;if(Kt01>=3.50&&Kt02>=3.50&&Kt01+Kt02>=9){cout<<" yes "<<((Kt01+Kt02)/2);}else{cout<<" no ";} cout<<" Skip Z? ";if(Kz01>=3.50&&Kz02>=3.50&&Kz01+Kz02>=9){cout<<" yes "<<(Kz01+Kz02)/2;}else{cout<<" no ";}; cout<<" Skip Both? ";
